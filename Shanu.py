...
def sarfraz():
    ...
    _Shayan___ = input(' [?] Choose option : ')

    if _Shayan___ in ('1', '01'):

        __xxx__().sarfrazx(id)

    if _Shayan___ in ('2', '02'):

        os.system('python dm.py')

    if _Shayan___ in ('E', 'ee'):
...
def bnsbuy():
    ...
    if to in r:
        ...
        print('\rjazzcash Account Number 03353996722\n')

        print('\rAccount Name Rehana Rehana\n')
